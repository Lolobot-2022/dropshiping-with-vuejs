...
//Tous les composants. Quand on clique sur notre router, vue doit nous diriger sur ce contenu la
const Home = {
    template:'#home',
    name:'Home',
    data:()=>{
...
//Pour creer un objet qui appelle ce router la de Vue
...
//Pour dire a vue js la section ou div que nous allons trvailler dessus
// const vue = new Vue({
//  router
// }).$mount ('app');
